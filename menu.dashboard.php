...
<div class="webweb_wp_plugin">
    <div class="wrap">
        ...
        <table class="app_table">
            <tr>
                <td>Plugin Status</td>
                <td><?php echo empty($opts['status']) ? $orb_wp_simple_ui_obj->msg('Disabled') : $orb_wp_simple_ui_obj->msg('Enabled', 1);?></td>
            </tr>            
        </table>
		...
		<h3>Comment</h3>
		<div id="fb-root"></div><script src="//connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:comments href="<?php echo $orb_wp_simple_ui_obj->get('plugin_home_page');?>" num_posts="5" width="500"></fb:comments>
    </div>
</div>
